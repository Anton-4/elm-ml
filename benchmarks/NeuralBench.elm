module NeuralBench exposing (main, suite)
...
suite : Benchmark
suite =
    describe "Neural Net Training"
        genBenchmarks -- last run: 118/s
...
genBenchmarks =
    ...
    in  
        case denseNet1Res of
            Ok net ->
                case singleMNISTDigitRes of
                    Ok singleMNISTDigit ->
                        [
                            benchmark "forward" <|
                            \_ -> forward singleMNISTDigit net
                        ]
                    Err _ ->
                        []
            Err _ ->
